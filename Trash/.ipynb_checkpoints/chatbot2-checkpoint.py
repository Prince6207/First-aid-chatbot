...
TAG_ORDER = ["definition", "cause", "symptoms", "prevention", "food", "medicine", "post-recovery"]
...
class MedicalChatbot:
    ...
    def predict_intent_rnn(self, text, max_len=64, oov_threshold=0.25, confidence_threshold=0.5, temperature=2.0):
    ...
    def reply(self, text: str) -> Dict[str, Any]:
        ...
        diseases = clean_topk(find_top_k(vec, 1))
